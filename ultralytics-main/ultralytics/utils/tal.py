...
class TaskAlignedAssigner(nn.Module):
    ...
    def __init__(self, topk=13, num_classes=80, alpha=1.0, beta=6.0, eps=1e-9):
        ...
        self.beta = beta
        self.eps = eps
        self.ratio = torch.nn.Parameter(torch.tensor(0.4))
    ...
    def iou_calculation(self, gt_bboxes, pd_bboxes):
        ...
        return self.ratio * (wasserstein_loss(gt_bboxes, pd_bboxes).squeeze(-1).clamp_(0)) + (1- self.ratio)*(bbox_iou(gt_bboxes, pd_bboxes, xywh=False, CIoU=True).squeeze(-1).clamp_(0))
